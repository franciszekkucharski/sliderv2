class Slider {
    ...
    create() {
        ...
        this.classNameActive = this.slider.test(typeof this.settings.activeClassName !== "string", new TypeError("WartoĹÄwĹaĹciwoĹci activeClassName nie jest ciÄgiem znakĂłw, przekazana wĹaĹciwoĹÄ to: " + this.settings.activeClassName), this.settings.activeClassName);
    this.classNamePrev = this.slider.test(typeof this.settings.prevClassName !== "string", new TypeError("WartoĹÄ wĹaĹciwoĹci prevClassName nie jest ciÄgiem znakĂłw, przekazana wĹaĹciwoĹÄ to: " + this.settings.prevClassName), this.settings.prevClassName);
    this.classNameFirst = this.slider.test(typeof this.settings.firstClassName !== "string", new TypeError("WartoĹÄ wĹaĹciwoĹci firstClassName nie jest ciÄgiem znakĂłw, przekazana wĹaĹciwoĹÄ to: " + this.settings.firstClassName), this.settings.firstClassName);
    this.classNameLoading = this.slider.test(typeof this.settings.loadingClassName !== "string", new TypeError("WartoĹÄ wĹaĹciwoĹci loadingClassName nie jest ciÄgiem znakĂłw, przekazana wĹaĹciwoĹÄ to: " + this.settings.loadingClassName), this.settings.loadingClassName);
    this.classNameLoadError = this.slider.test(typeof this.settings.loadErrorClassName !== "string", new TypeError("WartoĹÄ wĹaĹciwoĹci loadErrorClassName nie jest ciÄgiem znakĂłw, przekazana wĹaĹciwoĹÄ to: " + this.settings.loadErrorClassName), this.settings.loadErrorClassName);
    this.classNameLoaded = this.slider.test(typeof this.settings.loadedClassName !== "string", new TypeError("WartoĹÄ wĹaĹciwoĹci loadedClassName nie jest ciÄgiem znakĂłw, przekazana wĹaĹciwoĹÄ to: " + this.settings.loadedClassName), this.settings.loadedClassName);
    this.classNameAnimation = this.slider.test(typeof this.settings.animation !== "string", new TypeError("WartoĹÄ wĹaĹciwoĹci animation nie jest ciÄgiem znakĂłw, przekazana wĹaĹciwoĹÄ to: " + this.settings.animation), this.settings.animation);
    this.classNameJS = this.slider.test(typeof this.settings.jsClassName !== "string", new TypeError("WartoĹÄ wĹaĹciwoĹci jsClassName nie jest ciÄgiem znakĂłw, przekazana wĹaĹciwoĹÄ to: " + this.settings.jsClassName), this.settings.jsClassName);
    ...
    options(options) {
        Object.assign(this.settings, this.slider.test(typeof options !== "object", "Do klasy slider zostaĹ przekazany argument niebÄdÄcy obiektem, przekazany argument to: " + options, options));
    return this;
    }
